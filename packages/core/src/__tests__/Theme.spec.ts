...
const SCALE_VECTOR = [0.9725490196078431, 0.5490196078431373, 0.5529411764705883, 1.0];
const SCALE_NUMBER = -7500552;

// these are variants from the mock theme config above
const STROKE_VECTOR = [0.996078431372549, 0.996078431372549, 0.996078431372549, 1.0];

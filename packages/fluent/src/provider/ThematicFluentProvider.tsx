 ...
 */
export const ThematicFluentProvider: FC<ThematicFluentProviderProps> = ({ theme, children, id, className, style }) => {
	...
	return (
		<ThematicProvider theme={theme}>
			<ThematicFluentContext.Provider value={combinedTheme}>
				<ThemeProvider id={id} className={className} style={style} theme={fluentTheme}>
					{children}
				</ThemeProvider>

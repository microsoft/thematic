 ...
 */
import { useChartSize, useDrawLinks, useDrawNodes, useGraph } from '../../../../state/index.js';
...
export const ThemeViewer = () => {
	...
	return <ThemeViewerBase drawNodes={drawNodes} drawLinks={drawLinks} chartSize={chartSize} graph={graph} />;
};

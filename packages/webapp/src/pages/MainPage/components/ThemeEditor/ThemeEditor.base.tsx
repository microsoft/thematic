		...
		<div className="editor-wrapper">
			...
			<div className="footer">
				<div className="privacy">
					...
					<a target="_blank" rel="noreferrer" href="https://privacy.microsoft.com/en-us/privacystatement/">
				...
				<div className="github">
					Contribute at&nbsp;
					<a target="_blank" rel="noreferrer" href="https://github.com/microsoft/thematic">
						GitHub
					</a>
					.
				</div>

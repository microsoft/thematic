...
export const ApplicationPalette: FC = () => {
	...
	return (
		<div className="application-palette">
			<ColorStrip vertical={true} colorDefinitions={primaries} swatchStyle={styles.swatch} labelStyle={styles.label} />
			<ColorStrip vertical={true} colorDefinitions={signals} swatchStyle={styles.swatch} labelStyle={styles.label} />
			<ColorStrip
				vertical={true}
			...
			/>
			<ColorStrip vertical={true} colorDefinitions={elements} swatchStyle={styles.swatch} labelStyle={styles.label} />
		</div>
	);
};

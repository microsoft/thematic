	...
	return (
		<div style={styles.root}>
			<div>
				...
				<ColorStrip vertical={true} colorDefinitions={primaries} swatchStyle={styles.swatch} />
			</div>
			<div>
				<div style={styles.header}>Foreground</div>
				<ColorStrip vertical={true} colorDefinitions={foregrounds} swatchStyle={styles.swatch} />
			</div>
			<div>
				<div style={styles.header}>Background</div>
				<ColorStrip vertical={true} colorDefinitions={backgrounds} swatchStyle={styles.swatch} />
			</div>
		</div>
	);
};
